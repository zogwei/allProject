...
@Component("monthlySalesStatsListConverter")
public class MonthlySalesStatsListConverter extends DefaultXmlConverter<Map<String,Object>>{
	...
	protected String toContent(Map<String,Object> map) {
		...
		content.append(SalesStatsConstant.MONTHLY_SALES_STATS_LIST_START);
		
		for(SalesStats s:salesStats){
			
		content.append(SalesStatsConstant.MONTHLY_SALES_STATS_START);
		...
		content.append(SalesStatsConstant.MONTHLY_SALES_STATS_END);
		}
		content.append(SalesStatsConstant.MONTHLY_SALES_STATS_LIST_END);
