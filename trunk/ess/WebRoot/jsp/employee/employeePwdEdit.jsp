...
<html>
	...
	<body>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<font class="navigation_style">当前位置:员工管理&raquo;修改密码</font>
		<br>
		<br>
			<form name="form1" method="post" action="<%=basePath %>employee/modifyPwd" id="form1">
			...
			cellspacing="1" >
				...
				<tr>
					...
					<td  align="left" nowrap class="col2">
						&nbsp;
						<input name="password" type="password" id="password" size="20" maxlength="32">
						&nbsp;
				...
				<tr>
					...
					<td  align="left" nowrap class="col2">
						&nbsp;
						<input name="repwd" type="password" id="repwd" size="20" maxlength="32">
						&nbsp;
						<span style="color:red"></span>
					</td>
				</tr>	
