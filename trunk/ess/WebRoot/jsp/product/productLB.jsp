...
<html>
	...
	<body>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<font class="navigation_style">当前位置:产品管理&raquo;添加产品类别</font>
		<br>
		<br>
		<form id="category_form" name="form1" method="post" action="<%=basePath %>floorCategory/add">
			<table width="60%" border="0" align="center" cellpadding="0"
				...
				<tr align="center">
					...
					<td width="50%" align="left" nowrap bgcolor="#FFFFFF" class="col2">
						&nbsp;
						<input id="categoryName" name="name" type="text" size="35">
						<span id="categoryName_msg" class="msg"></span>
					</td>
				</tr>
				<tr>
					<td width="4%" align="left" nowrap bgcolor="#FFFFFF" class="col2">
						<div align="right">
						&nbsp;&nbsp;&nbsp;&nbsp;
							描述：
						</div>
					</td>
					<td width="46%" align="left" bgcolor="#FFFFFF" class="col2">
						&nbsp;
		...
		<table width="60%" border="0" align="center" cellpadding="0"
			...
			<c:forEach items="${floorCategorys}" var="floorCategory" varStatus="stat">
				<tr align="center">
					<td width="10%"  nowrap bgcolor="#FFFFFF" class="col2">
