...
<html>
	...
	<body>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<font class="navigation_style">当前位置:产品管理&raquo;添加产品纹理</font>
		<br>
		<br>
		<form id="vein_form" name="form1" method="post" action="<%=basePath %>vein/add">
			<table width="60%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td width="50%" align="left" nowrap bgcolor="#FFFFFF" class="col2">
						&nbsp;
						<input id="veinName" name="name" type="text" size="35">
		...
		<table width="60%" border="0" align="center" cellpadding="0"
			...
			<c:forEach items="${veins}" var="vein" varStatus="stat">
				<tr align="center">
					<td width="10%"  nowrap bgcolor="#FFFFFF" class="col2">
