...
public class FloorColorCodeEndpointTest 
{
	private static final Log logger = LogFactory.getLog(FloorColorCodeEndpoint.class);
	...
	public void testGetColorCodeList() {
			...
			HttpPost post = new HttpPost(UriGetter.COLOR_CODE_LIST);
			try{
				...
				FileOperator
						.writeFromResponse("D://colorCodeListResponse.xml", response);
			}catch(IOException e){
				logger.error(e);
			}
	}
