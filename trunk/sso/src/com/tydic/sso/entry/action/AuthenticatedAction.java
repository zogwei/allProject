 ...
 * @date  
 *	Created On : 2009-11-04 11:04:32 AM
 * @version 
 *	1.0
 **/
public class AuthenticatedAction  extends AbstractAction {
    ...
    protected Event doExecute(final RequestContext context) throws Exception {
        ...
        if (StringUtils.hasText(request.getParameter("validated")) && "true".equals(request.getParameter("validated"))) {
