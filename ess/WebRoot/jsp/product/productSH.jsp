...
<html>
	...
	<body>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<font class="navigation_style">当前位置:产品管理&raquo;添加产品色号</font>
		<br>
		<br>
		<form id="colorCode_form" name="form1" method="post" action="<%=basePath %>colorCode/add">
			<table width="60%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td width="50%" align="left" nowrap bgcolor="#FFFFFF" class="col2">
						&nbsp;
						<input id="colorCodeName" name="name" type="text" size="35">
				...
				<tr>
					...
					<td width="69%" align="left" bgcolor="#FFFFFF" class="col2">
						&nbsp;
		...
		<table width="60%" border="0" align="center" cellpadding="0"
			...
			<c:forEach items="${colorCodes}" var="colorCode" varStatus="stat">
				<tr align="center">
					<td width="10%"  nowrap bgcolor="#FFFFFF" class="col2">
						${stat.index + 1}
					</td>
