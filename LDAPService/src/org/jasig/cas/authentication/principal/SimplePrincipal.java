 ...
 * @since 3.1
 */
public class SimplePrincipal implements Principal,PrincipalExt {
    ...
    private Date updatePsdDate;
    
    public SimplePrincipal(final String id) {
        this(id, null);
        updatePsdDate = new Date();
    }
    ...
    public SimplePrincipal(final String id, final Map<String, Object> attributes) {
        ...
        updatePsdDate = (Date)attributes.get("updatePsdDate");//获取密码修改时间
    }
	...
	public Date getUpdatePsdDate() {
		// TODO Auto-generated method stub
		return this.updatePsdDate;
	}

	public void setUpdatePsdDate(Date date) {
		this.updatePsdDate = date;
	}
}
